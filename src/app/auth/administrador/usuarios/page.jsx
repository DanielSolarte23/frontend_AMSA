      ...
      <div className="h-screen flex flex-col justify-center items-center">
        ...
        <form onSubmit={handleSubmit} className="mb-6 space-y-3 bg-gray-100 dark:bg-gray-900 p-4 rounded-lg">
          <input
            ...
            placeholder="Nombre"
            className="w-full px-2 py-3 border rounded border-gray-600 bg-gray-100 dark:bg-gray-800"
            required
          />
          <input
            type="text"
          ...
          >
            ...
            <option value="vigilante">Personal de seguridad</option>
            <option value="propietario">propietario</option>
          </select>
          <button type="submit" className="w-full bg-blue-500 text-white px-2 py-3 rounded">
