...
function registro() {
  ...
  return (
    <section className="bg-white dark:bg-gray-900">
      ...
      <div className="container flex items-center px-6 mx-auto flex-col">
        <div className='w-full flex justify-center'><Image src="/VILLA_DEL_SOL.png" alt="Logo Conjunto Residencial" height={100} width={150} priority /></div>
