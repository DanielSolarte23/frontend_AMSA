...
function BarraLateral() {
    return (
        <aside className="flex flex-col w-64 h-full px-4 py-4 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
            <div className="flex flex-col items-center mt-2 -mx-2">
                ...
                <h4 className="mx-2 mt-1 font-medium text-gray-800 dark:text-gray-200">John Doe</h4>
